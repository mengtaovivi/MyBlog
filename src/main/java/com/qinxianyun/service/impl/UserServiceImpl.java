...
import com.qinxianyun.constant.RoleConstant;
import com.qinxianyun.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public String insert(User user) {
        ...
        user.setAvatarImgUrl("https://qinxianyun-myblog.oss-cn-shenzhen.aliyuncs.com/public/user/avatar/noLogin.jpg");
    ...
    public JSONObject getHeadPortraitUrl(int id) {
        ...
        if(!"".equals(avatarImgUrl) && avatarImgUrl != null){
            ...
            jsonObject.put("avatarImgUrl","https://qinxianyun-myblog.oss-cn-shenzhen.aliyuncs.com/public/user/avatar/noLogin.jpg");
        }
        return jsonObject;
    }
